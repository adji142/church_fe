  ...
  <div class="master-data-page">
    <div class="header-section">
      <div class="title-group">
        <h1 class="page-title">Master Kategori Layanan</h1>
        <p class="page-subtitle">Kelola kategori layanan kerohanian (contoh: Sakramen, Pastoral)</p>
      </div>
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <div class="header-text">
              ...
              <p>{{ editingId ? 'Ubah informasi kategori layanan' : 'Buat kategori layanan baru' }}</p>
            </div>
          ...
          <form @submit.prevent="saveData" class="modal-body">
            <div class="form-section">
              <div class="form-group full-width">
                ...
                <div class="input-wrapper">
                  ...
                  <input v-model="form.name" type="text" required placeholder="Contoh: Sakramen" :disabled="saving" />
                </div>
              </div>
              ...
              <div class="form-group full-width" style="margin-top: 1rem;">
                ...
                <div class="input-wrapper">
                  ...
                  <textarea v-model="form.description" rows="3" placeholder="Keterangan kategori..." :disabled="saving" class="text-area-input"></textarea>
                </div>
              </div>
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-primary btn-lg" :disabled="saving">
                ...
                <template v-else>
                  <Check size="18" />
                  <span>{{ editingId ? 'Update Kategori' : 'Simpan Kategori' }}</span>
                </template>
              </button>
            </div>
          </form>
...
import { 
  Plus, Edit2, Trash2, X, Search, Check, Type, ChevronLeft, ChevronRight, FileText
...
const saveData = async () => {
  ...
  try {
    if (editingId.value) {
      await axios.put(`/service-categories/${editingId.value}`, form.value);
    } else {
      await axios.post('/service-categories', form.value);
    }
...
const confirmDelete = async (item) => {
  ...
  if (result.isConfirmed) {
    try {
      await axios.delete(`/service-categories/${item.id}`);
      await fetchData(pagination.value.current_page);
...
.input-wrapper input, .text-area-input {
  width: 100%;
...
.input-wrapper input:focus, .text-area-input:focus {
  outline: none;
  border-color: #6366f1;
  background: white;
