  ...
  <div class="master-data-page wide">
    <div class="header-section">
      <div class="title-group">
        <h1 class="page-title">Laporan Dana (Fund Report)</h1>
        <p class="page-subtitle">Mengetahui rincian saldo awal, mutasi, dan saldo akhir tiap jenis dana</p>
      </div>
    ...
    <div class="card filter-card report-section-gap">
      ...
      <div class="p-6">
        ...
        <div class="filter-item min-w-[200px]">
            <span class="filter-label">Dana (Found)</span>
        ...
        <table class="modern-table border-none">
          <thead class="bg-slate-50/50">
            <tr>
              ...
              <th class="text-right text-rose-600">Keluar</th>
...
const fetchReport = async () => {
  ...
  loading.value = true;
  try {
    const res = await axios.get('/reports/cash-fund', {
